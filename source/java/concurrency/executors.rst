...
.. container:: left-col
    ...
    При попытке изъятия задачи из очереди проверяется является ли она poison pill, *и если да - дальнейшее добавление задач не происходит (кидается исключение)* - **УТОЧНИТЬ**.
