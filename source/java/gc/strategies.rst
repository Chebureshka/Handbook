...
.. container:: left-col
    ...
    Достоинством данного сборщика по сравнению с Serial / Parallel GC является его ориентированность на минимизацию времен простоя, что является критическим фактором для многих приложений. 
...
.. container:: right-col
    ...
    .. toggle-header::
        :header: Механизм действия

        .. figure:: ../../_static/NJc64_.png
